...
window.onload = function init() {
    ...
    u_hsv_user_input = gl.getUniformLocation(program, "u_hsv_user_input");
...
function initControls() {
    ...
    document.getElementById("hsv_offset_h").oninput = function (event) {
        hsv_offset_h = parseFloat(event.target.value);

        console.log(hsv_offset_h)

    };
    document.getElementById("hsv_offset_s").oninput = function (event) {
        hsv_offset_s = parseFloat(event.target.value);

    };
    document.getElementById("hsv_offset_v").oninput = function (event) {
        hsv_offset_v = parseFloat(event.target.value);
...
function render() {
    ...
    gl.uniform3fv(u_hsv_user_input, flatten(vec3(hsv_offset_h, hsv_offset_s, hsv_offset_v)));
