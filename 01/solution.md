...
1. Games: Computer graphics are used in both video and AR/VR games in order to achieve real time rendering.
2. Data Visualization: Computer graphics are used to visualize the data to enhance readibilty.
