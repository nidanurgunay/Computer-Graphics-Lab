...
1. Games: Computer graphics are used in both video and AR/VR games
2. Data Visualization: Computer graphics are used to visualize the data.
3. Architecture: Computer graphics are used in architecture to achieve a realistic simulation of the project.
4. Movies: Computer Graphics are used in movies to have animated screens in order to increase reality.
