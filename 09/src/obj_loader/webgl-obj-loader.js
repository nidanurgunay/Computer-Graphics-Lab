...
(function (TYPES) {
    ...
    TYPES["FLOAT"] = "FLOAT";
    TYPES["UNSIGNED_INT"] = "UNSIGNED_INT";
})(TYPES || (TYPES = {}));
/**
...
Layout.MATERIAL_ENABLED = new Attribute("materialEnabled", 1, TYPES.UNSIGNED_INT);
...
Layout.ILLUMINATION = new Attribute("illumination", 1, TYPES.UNSIGNED_INT);
...
Layout.ANTI_ALIASING = new Attribute("antiAliasing", 1, TYPES.UNSIGNED_INT);
...
function _buildBuffer(gl, type, data, itemSize) {
    ...
    const arrayView = type === gl.ARRAY_BUFFER ? Float32Array : Uint32Array;
