...
- $q_1$ = $\cos$($\theta_1$/ 2) + $\sin(\theta_1$ / 2) $(u_xi, u_zj, u_zk) $   
- $q_2$ = $\cos(\theta_2$ / 2) + $\sin(\theta_2$ / 2) $(u_xi, u_zj, u_zk)$   

- $q_1$.$q_2$ =  $\cos$($\theta_1$ / 2)$\cos$($\theta_1$ / 2)  + $\cos$($\theta_1$ / 2)\sin(\theta_2 / 2) (u_xi, u_zj, u_zk) + \cos(\theta_2 / 2)\sin(\theta_1 / 2) (u_xi, u_zj, u_zk)  + \sin(\theta_1 / 2) (u_xi, u_zj, u_zk)\sin(\theta_2 / 2) (u_xi, u_zj, u_zk) $   

- $q_2.q_1 = \cos(\theta_1 / 2)\cos(\theta_2 / 2) + \cos(\theta_2 / 2)\sin(\theta_1 / 2) (u_xi, u_zj, u_zk) + \cos(\theta_1 / 2)\sin(\theta_2 / 2) (u_xi, u_zj, u_zk) + \sin(\theta_1 / 2) (u_xi, u_zj, u_zk)\sin(\theta_2 / 2) (u_xi, u_zj, u_zk) $   
